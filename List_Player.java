...
public class List_Player {
	...
	private void initialize() {
		...
		JLabel lblAddPlayer = new JLabel("List Player");
		...
		label_2.setIcon(new ImageIcon("C:\\Users\\Zahir Animon\\Documents\\Computer Science\\Icons\\List_64px.png"));
		...
		Playerstable.setBounds(10, 86, 516, 354);
		panel_1.add(Playerstable);
		
		try
	    {
	    CreateConnection();
	    java.sql.PreparedStatement st =c.prepareStatement("Select * from Players;");
